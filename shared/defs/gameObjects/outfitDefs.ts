...
const SkinDefs: Record<string, OutfitDef> = {
    ...
    // karambit_dotexe is the knife for this skin 
    ...
    outfitChromesis: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            ...
            backpackSprite: "player-circle-base-01.img",
            frontSpritePos: { x: -5, y: 0 },
            frontSprite: "player-accessory-chrome.img",
            aboveHand: false,
        },
        lootImg: {
    ...
    outfitReTag: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-outfitVitaminD.img",
            handTint: 0xffffff,
