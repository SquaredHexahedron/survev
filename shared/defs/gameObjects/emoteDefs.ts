...
export const EmotesDefs: Record<string, EmoteDef> = {
    ...
    emote_adren: {
        type: "emote",
        texture: "emote-medical-pill.img",
        sound: "emote_01",
        channel: "ui",
        teamOnly: true,
        noCustom: true,
    ...
    emote_shootingstar: {
        ...
        name: "Shooting Star",
        rarity: Rarity.Rare,
        texture: "space-shootingstar.img",
        sound: "emote_01",
        channel: "ui",
        teamOnly: false,
        category: EmoteCategory.Other,
